  ...
  return (
    <div className='max-w-xs rounded-lg overflow-hidden bg-white transition-transform duration-300 hover:shadow-xl hover:scale-105 mx-auto'>
      ...
      <div className='relative'>
        ...
        <button className='absolute top-2 right-2 text-gray-500 hover:text-red-500 transition-colors text-xs font-bold px-2 py-1 rounded'>
          {/* 矢量图，数学图形来画图，支持无限放大，不会模糊，区别于像素图 */}
